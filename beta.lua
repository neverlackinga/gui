...
main9:NewButton("Disable Esp", "Disables esp", function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/neverlackinga/esp/main/esp2.lua"))()
end)
local main10 = main9:NewSection("Chams")
main8:NewButton("Start Esp", "Injects esp", function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/neverlackinga/esp/main/chams.lua"))()
end)
